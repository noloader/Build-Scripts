...
OSX_1010_OR_ABOVE=$(${EGREP} -i -c "(^10.10|^1[1-9].|^[2-9][0-9])" <<< "$OSX_VERSION")
OSX_105_OR_BELOW=$(${EGREP} -i -c "OS X 10\.[0-5]" <<< "$OSX_VERSION")
...
INSTX_UNBOUND_ROOTKEY_PATH="${INSTX_PREFIX}/etc/unbound"
INSTX_UNBOUND_ROOTKEY_FILE="${INSTX_PREFIX}/etc/unbound/root.key"
INSTX_UNBOUND_ICANN_PATH="${INSTX_PREFIX}/etc/unbound"
INSTX_UNBOUND_ICANN_FILE="${INSTX_PREFIX}/etc/unbound/icannbundle.pem"

export INSTX_CACERT_PATH INSTX_CACERT_FILE
export INSTX_UNBOUND_ROOTKEY_PATH INSTX_UNBOUND_ROOTKEY_FILE
export INSTX_UNBOUND_ICANN_PATH INSTX_UNBOUND_ICANN_FILE
